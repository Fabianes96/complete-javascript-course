...
const ownersEatTooMuch = dogs.reduce((acc,dog)=>{
  dog.curFood > dog.recommendedFood && acc.push(dog) 
  return acc
...
console.log(ownersEatTooMuch.join(' and ').concat(`'s dogs eat to much!`));
console.log(ownersEatTooLittle.join(' and ').concat(`'s dogs eat to little!`));
