...
for (const team of Object.entries(game.odds)) {
  console.log(`Odd of ${game[team[0]] || "draw"}: ${team[1]}`);
}
...
//   ["question", "What's the best programing lenguage"],
//   [1, "C"],
//   [2, "Java"],
//   [3, "Javascript"],
//   ['correct', 3],
...
// console.log(answerMap.get("question"));
...
// console.log(answerMap.get(answer === 3));
...
//3
console.log(`An event happend, on avarage ${90 / gameEvents.size} minutes`);
...
document.querySelector('button').addEventListener('click', function () {
  ...
  for(const str of rows){
    ...
    let correct = first.concat(second)    
    console.log(correct);
  }
});
